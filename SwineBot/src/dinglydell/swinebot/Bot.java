...
import net.minecraft.server.v1_11_R1.PathfinderGoalNearestAttackableTarget.DistanceComparator;
...
public class Bot extends EntityCreature {
	...
	public Bot(Location location, String npcName){
		...
		player = new EntityPlayerDummy(this, ((CraftServer) Bukkit.getServer()).getServer(), ((CraftWorld) location.getWorld()).getHandle(), new GameProfile(UUID.randomUUID(), npcName), new PlayerInteractManager(((CraftWorld) location.getWorld()).getHandle()));
	...
	public void start(){
		...
		this.goalSelector.a(3, new PathfinderGoalMoveTowardsTarget(this, 0.5d, 999f));
		this.goalSelector.a(5, new PathfinderGoalMoveTowardsRestriction(this, 1.0D));
		//this.goalSelector.a(7, new PathfinderGoalRandomStrollLand(this, 1.0D));
		this.goalSelector.a(8, new PathfinderGoalLookAtPlayer(this, EntityHuman.class, 8.0F));
		this.goalSelector.a(8, new PathfinderGoalRandomLookaround(this));
		targetSelector.a(0, new PathfinderGoalHurtByTarget(this, true, EntityPlayer.class));
		targetSelector.a(1, new PathfinderGoalNearestBot(this, true));
		targetSelector.a(2, new PathfinderGoalNearestAttackableTarget<EntityPlayer>(this, EntityPlayer.class, true));
	...
	public void showToPlayer(Player p) {
    	...
    	connection.sendPacket(new PacketPlayOutPlayerInfo(PacketPlayOutPlayerInfo.EnumPlayerInfoAction.ADD_PLAYER, new EntityPlayer[] {player}));
	...
	public void leave() {
	    ...
	    for(EntityHuman h : world.players){
	    	Player p = (Player)h.getBukkitEntity();
	       	...
	       	connection.sendPacket(new PacketPlayOutPlayerInfo(PacketPlayOutPlayerInfo.EnumPlayerInfoAction.REMOVE_PLAYER, new EntityPlayer[]{player}));
	...
	public void look(float yaw, float pitch){
		...
		sendPackets(new PacketPlayOutEntityLook(getId(), y, p, onGround), new PacketPlayOutEntityHeadRotation(player, y));
	}
	...
	public void move() {
		...
		sendPackets(new PacketPlayOutEntityTeleport(player), new PacketPlayOutEntityHeadRotation(player, (byte)(this.yaw * 256.0F / 360.0)));
	}
	...
	public boolean isLookingAtMe(Player player) {
		...
		double dist = player.getLocation().distanceSquared(new Location(this.world.getWorld(), locX, locY, locZ));
		if(dist > 16){
			return false;
